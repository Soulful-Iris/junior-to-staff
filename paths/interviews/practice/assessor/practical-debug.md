...
[repair key](../../coding/labs/importer/assessor.md). Candidate-visible regressions
...
```sh
python paths/interviews/practice/assessor/heldback_importer.py --package starter
```
...
| 60 min | [Three PRs](../../coding/labs/importer/review/README.md) | Block conflict suppression and early retry; approve bounded non-payload metadata with check |
...
Debrief: [domain identity](../../coding/lessons/01-maps.md),
[importer method](../../coding/labs/importer/README.md),
[runtime/budgets](../../coding/labs/bounded-executor/runtime.md). Next occasion use
