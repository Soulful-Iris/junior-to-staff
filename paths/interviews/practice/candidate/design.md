...
Constructed 50-minute design session. Prerequisites: [architecture concepts](../../architecture/concepts.md)
and [queue delivery](../../aws/labs/job-pipeline/README.md), studied before session day.
