...
Constructed practice, not a company interview. Prerequisites: ratios, Boolean AND/OR, and [the reliability chapter](../../../tiers/02-senior/09-reliability/README.md). Do the arithmetic independently before running the reference.
...
```bash
python -m unittest discover -s paths/interviews/reliability -p 'test_*.py' -v
```
