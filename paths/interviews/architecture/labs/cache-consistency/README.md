...
Prerequisites: [cache and replica concepts](../../concepts.md), Python 3.11+,
...
```bash
python -m unittest discover -s paths/interviews/architecture/labs/cache-consistency -p 'test_*.py' -v
```
...
[lease/recovery lab](../recovery-migration/README.md).
