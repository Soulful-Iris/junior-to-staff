...
Prerequisites: the [atomic-result queue lab](../../../aws/labs/job-pipeline/README.md)
and [transaction concepts](../../concepts.md). This is a **separate extension**:
...
```bash
python -m unittest discover -s paths/interviews/architecture/labs/recovery-migration -p 'test_*.py' -v
```
