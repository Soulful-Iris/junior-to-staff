...
These are candidate mappings, not a requirement to use every service. Follow the [AWS labs](../aws/README.md) for implementation and current primary references.
...
[Concepts](concepts.md) · [Worked designs](designs.md) · [Coding route](../coding/README.md)
