...
| 28 | [Manual LRU cache](28-manual-lru-cache/README.md) | Map/list identity and pointer invariants |
| 29 | [Expiring key-value store](29-expiring-key-value-store/README.md) | Strict expiry boundary and cleanup authority |
...
| 40 | [Event-time windows](40-event-time-windows/README.md) | Watermark authority, lateness, and finality |
| 41 | [Streaming median](41-streaming-median/README.md) | Ordered halves, balancing, and exact arithmetic |
| 42 | [Bounded blocking queue](42-bounded-blocking-queue/README.md) | Predicate loops, admission, deadlines, and shutdown |
