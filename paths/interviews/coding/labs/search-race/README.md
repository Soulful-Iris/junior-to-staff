...
Constructed 30-minute session. Prerequisite: [runtime model](../bounded-executor/runtime.md).
Keep [reference](../../typescript.ts) and [tests](../../typescript.test.ts) separate
...
Run from root: `node --test paths/interviews/coding/typescript.test.ts`. The
[real bookmark slice](../../../full-stack/bookmark-editor/README.md) adds browser
