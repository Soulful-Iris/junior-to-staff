...
Constructed 30-minute debugging session. Prerequisite: [explicit identity](../../lessons/01-maps.md).
...
serialize writes; use [the editor's conditional store operation](../../../full-stack/bookmark-editor/README.md).
