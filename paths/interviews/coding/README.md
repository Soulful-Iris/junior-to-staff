...
| 10 | [State → LRU cache](lessons/10-lru.md) | Reads, overwrites, and eviction preserve recency |
| 11 | [TypeScript → concurrency and stale responses](practical.md) | You test rejected work and out-of-order completion |
| 12 | [Timed mock → feedback and repeat](mock.md) | You solve, test, explain, and adapt without hints |
...
[Contracts and solutions](reference.md) · [Why the patterns work](pattern-notes.md) · [Current interview evidence](../research/README.md) · [Interview home](../README.md)
