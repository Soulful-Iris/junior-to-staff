...
Prerequisites: [search generations](../../coding/labs/search-race/README.md),
[runtime boundaries](../../coding/labs/bounded-executor/runtime.md), and the
[full-stack route](../README.md).
...
```sh
cd paths/interviews/full-stack/bookmark-editor
node build.mjs
