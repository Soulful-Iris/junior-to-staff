...
Related prerequisites for deeper follow-ups: [Observability](../../03-production/04-observability/README.md) · [Data at scale](../01-data-at-scale/README.md).

[Choose an independent assessment](../../../practice/README.md) · [Assessment depth](../../../practice/depth.md)

Next chapter: [AI systems](../03-ai-systems/README.md).
