...
[System design](../01-system-design/README.md)
...
Related prerequisites for deeper follow-ups: [Infrastructure as code and AWS](../03-infrastructure/README.md) · [Observability](../04-observability/README.md) · [Migrations and recovery](../../04-scale-and-evolution/04-migrations/README.md).

## Apply the concept

Each link opens one existing project brief with its own context, diagrams, AI prompts, AWS choices and follow-ups.

- [Twenty deploys a day](projects/twenty-deploys-a-day.md)

[Choose an independent assessment](../../../practice/README.md) · [Assessment depth](../../../practice/depth.md)

Next chapter: [Infrastructure as code and AWS](../03-infrastructure/README.md).
