...
[Curriculum](../../../README.md) · [CI/CD and progressive delivery](../README.md) · [Project index](../../../../indexes/projects.md)
...
**First slice:** Deploy artifact v2 with its new UI flag off. Enable it for 1%, inspect cohort errors/latency, then 10%; disable the flag and verify new entry stops while v1/v2 can both read current data. **Show:** pipeline run, cohort dashboard, feature flag history and one practiced rollback. Deliberately propose dropping a v1-required column early; the migration gate must refuse it.
