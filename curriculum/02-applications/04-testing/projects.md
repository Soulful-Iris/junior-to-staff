...
<a id="1-the-suite-that-can-fail"></a>

### 1. Measure whether existing checks detect real defects
...
<a id="2-the-contract-nobody-breaks-by-accident"></a>

### 2. Protect API response types, units and compatibility
...
<a id="3-the-flake-hunter"></a>

### 3. Reproduce and remove order-dependent failures
...
<a id="4-the-load-test-that-finds-the-real-limit"></a>

### 4. Measure API capacity with controlled arrival rates
...
<a id="5-the-test-that-runs-in-production-forever"></a>

### 5. Design and run a synthetic reading-list journey
