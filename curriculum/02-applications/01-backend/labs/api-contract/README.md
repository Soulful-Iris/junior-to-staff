...
Prerequisites: JSON, HTTP status codes, and [API ownership](../../../../03-production/01-system-design/mechanism-reference.md).
...
[AWS route](../../../../03-production/03-infrastructure/aws/README.md) · [Recovery extension](../../../../04-scale-and-evolution/04-migrations/labs/recovery-migration/README.md)
