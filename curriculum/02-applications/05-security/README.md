...
[Testing, debugging, and code review](../04-testing/README.md)
...
Related prerequisites for deeper follow-ups: [Data at scale](../../04-scale-and-evolution/01-data-at-scale/README.md) · [Migrations and recovery](../../04-scale-and-evolution/04-migrations/README.md).

## Apply the concept

Each link opens one existing project brief with its own context, diagrams, AI prompts, AWS choices and follow-ups.

- [A shift schedule](projects/a-shift-schedule.md)

[Choose an independent assessment](../../../practice/README.md) · [Assessment depth](../../../practice/depth.md)

Next chapter: [System design](../../03-production/01-system-design/README.md).
