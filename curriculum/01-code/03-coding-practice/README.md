...
3. **Identity and traversal:** linked lists, trees, ancestry, and paths.
4. **Connections and priorities:** dependencies, BFS, union-find, weighted paths, heaps, and tries.
5. **Search and reuse:** combinations, board search, and dynamic programming.
6. **Unresolved work:** monotonic stacks, parsing, and streaming medians.
7. **Rehearse independently:** timed prompts with observable outputs and follow-ups.

The contents panel gives every problem its own step. Stateful caches, expiry, event-time aggregation, and concurrency return later alongside the backend and data-system concepts they exercise.
