...
Prerequisites: [the act index](../README.md) and [the tier starting point](../../../tiers/03-staff/16-scope-and-leverage/README.md). This page is a build brief; it does not ship a runnable application. The original build and prompt sequence below defines the implementation checkpoints.
...
- [Region loss and rebalancing exercise](../../../paths/interviews/architecture/labs/recovery-migration/regions.md) — includes its own run command, fixtures and validation limits.
