...
Prerequisites: [P3](../p3-under-load/README.md). This page is a build brief; it does not ship a runnable application. The original build and prompt sequence below defines the implementation checkpoints.
...
- [Runnable evaluation and judge fixtures](../../paths/interviews/evaluations/README.md) — includes its own run command, fixtures and validation limits.
