...
<article class="sample-panel active" id="sample-algorithm" role="tabpanel" aria-labelledby="sample-tab-algorithm" aria-hidden="false" data-sample-panel="algorithm">
...
<div class="window-demo" role="img" aria-label="The first valid window ADOBEC shrinks as the search continues until BANC is the shortest valid window"><div class="visual-title"><span>MOVE THE WINDOW, NOT THE STRING</span><small>13 characters · one pass</small></div><div class="window-step"><span>First valid</span><div class="letter-row"><b class="candidate">A</b><b class="candidate">D</b><b class="candidate">O</b><b class="candidate">B</b><b class="candidate">E</b><b class="candidate">C</b><b>O</b><b>D</b><b>E</b><b>B</b><b>A</b><b>N</b><b>C</b></div><em>6 characters</em></div><div class="window-arrow" aria-hidden="true">expand → shrink → keep the best</div><div class="window-step final"><span>Best window</span><div class="letter-row"><b>A</b><b>D</b><b>O</b><b>B</b><b>E</b><b>C</b><b>O</b><b>D</b><b>E</b><b class="winner">B</b><b class="winner">A</b><b class="winner">N</b><b class="winner">C</b></div><em>4 characters</em></div><p>The left edge only moves forward. You never restart the search.</p></div></div>
...
<div class="payment-demo" role="img" aria-label="The first request charges the payment provider but loses its reply. The retry reuses order 42 and returns the recorded charge instead of charging again"><div class="visual-title"><span>ONE PURCHASE, ONE IDENTITY</span><small>retry-safe checkout</small></div><div class="payment-route"><i>01</i><span>Checkout<br><small>order-42</small></span><b aria-hidden="true">→</b><span>Payment provider</span><strong>$42 charged</strong></div><div class="lost-reply"><span aria-hidden="true">×</span> reply lost</div><div class="payment-route retry"><i>02</i><span>Retry<br><small>order-42</small></span><b aria-hidden="true">→</b><span class="payment-record">Attempt already recorded<br><small>charge ch_91</small></span><strong>Return result</strong></div><div class="no-second-charge"><span aria-hidden="true">✓</span> No second provider call</div></div></div>
...
<div class="aws-demo" role="img" aria-label="An Application Load Balancer stops routing to the failed task in Availability Zone A and keeps routing to a healthy task in Availability Zone B while an RDS Multi-AZ standby takes over"><div class="visual-title"><span>TRAFFIC AFTER THE FAILURE</span><small>multi-AZ application</small></div><div class="aws-entry"><span>Users</span><b aria-hidden="true">→</b><strong>Application Load Balancer</strong></div><div class="aws-zones"><section class="failed"><header>AZ A <span>offline</span></header><div>ECS task <b>×</b></div><small>Removed by health check</small></section><section class="healthy"><header>AZ B <span>healthy</span></header><div>ECS task <b>✓</b></div><small>Receives new traffic</small></section></div><div class="aws-database"><span>RDS primary</span><b aria-hidden="true">⇢</b><span>Multi-AZ standby</span><strong>Failover</strong></div></div></div>
