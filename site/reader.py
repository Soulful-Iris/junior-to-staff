...
<div class="window-demo" role="group" aria-label="The first valid window ADOBEC moves and contracts until BANC is the shortest valid window. A Counter hash map tracks how many A, B and C characters are inside the current window and how many are still missing."><div class="visual-title"><span>MOVE THE WINDOW, NOT THE STRING</span><small>window + Counter state</small></div><div class="window-animation-grid"><div><div class="window-scan-track"><div class="letter-row"><b>A</b><b>D</b><b>O</b><b>B</b><b>E</b><b>C</b><b>O</b><b>D</b><b>E</b><b>B</b><b>A</b><b>N</b><b>C</b></div><i class="window-frame" aria-hidden="true"></i></div><div class="window-readout" aria-hidden="true"><span class="window-first">First valid · ADOBEC · 6 characters</span><span class="window-searching">Keep moving the left edge →</span><span class="window-best">Best · BANC · 4 characters</span></div></div><aside class="counter-demo" aria-hidden="true"><header><span>COUNTER</span><small>window counts</small></header><div class="counter-states"><div class="counter-state counter-building"><em>Building</em><div><span><b>A</b><strong>1</strong></span><span><b>B</b><strong>0</strong></span><span><b>C</b><strong>0</strong></span></div><p>missing <strong>2</strong></p></div><div class="counter-state counter-valid"><em>Valid</em><div><span><b>A</b><strong>1</strong></span><span><b>B</b><strong>1</strong></span><span><b>C</b><strong>1</strong></span></div><p>missing <strong>0</strong></p></div><div class="counter-state counter-gap"><em>A removed</em><div><span><b>A</b><strong>0</strong></span><span><b>B</b><strong>1</strong></span><span><b>C</b><strong>1</strong></span></div><p>missing <strong>1</strong></p></div><div class="counter-state counter-final"><em>Best</em><div><span><b>A</b><strong>1</strong></span><span><b>B</b><strong>1</strong></span><span><b>C</b><strong>1</strong></span></div><p>missing <strong>0</strong></p></div></div></aside></div><p>The left edge only moves forward. You never restart the search.</p></div></div>
