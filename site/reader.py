...
<div class="window-demo" role="group" aria-label="The first valid window ADOBEC moves and contracts until BANC is the shortest valid window"><div class="visual-title"><span>MOVE THE WINDOW, NOT THE STRING</span><button class="sample-replay" type="button" data-replay-sample>Replay <i aria-hidden="true">&#8635;</i></button></div><div class="window-scan-track"><div class="letter-row"><b>A</b><b>D</b><b>O</b><b>B</b><b>E</b><b>C</b><b>O</b><b>D</b><b>E</b><b>B</b><b>A</b><b>N</b><b>C</b></div><i class="window-frame" aria-hidden="true"></i></div><div class="window-readout" aria-hidden="true"><span class="window-first">First valid · ADOBEC · 6 characters</span><span class="window-searching">Keep moving the left edge →</span><span class="window-best">Best · BANC · 4 characters</span></div><p>The left edge only moves forward. You never restart the search.</p></div></div>
