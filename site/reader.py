...
<div class="window-demo" role="group" aria-label="A slow six-step sliding-window explanation. The window expands until it contains A, B and C, shrinks until a needed letter is lost, then repeats. A Counter hash map compares the required count with the count currently inside the window. The shortest valid window is BANC."><div class="visual-title"><span>EXPAND, CHECK, THEN SHRINK</span><small>21-second walkthrough</small></div><div class="window-story" aria-hidden="true"><section class="story-one"><b>1 · EXPAND RIGHT</b><strong>Collect letters until the window has A, B, and C.</strong></section><section class="story-two"><b>2 · FIRST COMPLETE WINDOW</b><strong><code>ADOBEC</code> has all three. Save length 6.</strong></section><section class="story-three"><b>3 · SHRINK LEFT</b><strong>Remove A and the window becomes incomplete.</strong></section><section class="story-four"><b>4 · EXPAND AGAIN</b><strong>A returns. The extra B does not hurt.</strong></section><section class="story-five"><b>5 · C RETURNS</b><strong><code>ODEBANC</code> is complete, so shrink again.</strong></section><section class="story-six"><b>6 · SHORTEST SO FAR</b><strong><code>BANC</code> is complete in only 4 characters.</strong></section></div><div class="window-animation-grid"><div class="window-track-column"><div class="window-scan-track"><div class="letter-row"><b class="target-letter">A</b><b>D</b><b>O</b><b class="target-letter">B</b><b>E</b><b class="target-letter">C</b><b>O</b><b>D</b><b>E</b><b class="target-letter">B</b><b class="target-letter">A</b><b>N</b><b class="target-letter">C</b></div><i class="window-frame" aria-hidden="true"></i></div><div class="edge-legend"><span><i></i>current window</span><span>right edge expands →</span><span>← left edge shrinks</span></div></div><aside class="counter-demo" aria-hidden="true"><header><span>COUNTER HASH MAP</span><small>updated when an edge moves</small></header><div class="counter-head"><span>letter</span><span>need</span><span>in window</span></div><div class="counter-states"><section class="counter-state count-one"><div><b>A</b><i>1</i><strong>1</strong></div><div><b>B</b><i>1</i><strong>1</strong></div><div class="missing"><b>C</b><i>1</i><strong>0</strong></div><p>Missing <b>C</b></p></section><section class="counter-state count-two"><div><b>A</b><i>1</i><strong>1</strong></div><div><b>B</b><i>1</i><strong>1</strong></div><div><b>C</b><i>1</i><strong>1</strong></div><p class="complete">Complete ✓</p></section><section class="counter-state count-three"><div class="missing"><b>A</b><i>1</i><strong>0</strong></div><div><b>B</b><i>1</i><strong>1</strong></div><div><b>C</b><i>1</i><strong>1</strong></div><p>Missing <b>A</b></p></section><section class="counter-state count-four"><div><b>A</b><i>1</i><strong>1</strong></div><div class="extra"><b>B</b><i>1</i><strong>2</strong></div><div><b>C</b><i>1</i><strong>1</strong></div><p class="complete">Complete · extra B is okay</p></section><section class="counter-state count-five"><div><b>A</b><i>1</i><strong>1</strong></div><div><b>B</b><i>1</i><strong>1</strong></div><div><b>C</b><i>1</i><strong>1</strong></div><p class="complete">Complete ✓</p></section><section class="counter-state count-six"><div><b>A</b><i>1</i><strong>1</strong></div><div><b>B</b><i>1</i><strong>1</strong></div><div><b>C</b><i>1</i><strong>1</strong></div><p class="complete">Complete · best length 4</p></section></div></aside></div><p>Only the two edges move. The Counter tells you when shrinking must stop.</p></div></div>
