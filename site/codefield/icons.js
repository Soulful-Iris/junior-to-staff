...
// Inner SVG only; icon() wraps it at the size and stroke asked for.
export const PATHS = {
...
export function icon(name, size = 16, cls = '', stroke = 2) {
  return `<svg class="cf-ic ${cls}" xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${stroke}" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${PATHS[name]}</svg>`;
}
