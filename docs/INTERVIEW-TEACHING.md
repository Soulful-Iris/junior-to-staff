...
Start with the shared [learning experience](LEARNING-EXPERIENCE.md).
It governs the whole curriculum: introduce the actual problem and expected values before
