...
Use [the worked designs](../indexes/system-designs.md) as prompts before reading their solutions. Record the session or keep a timestamped outline. At minute 25, introduce a changed constraint: ten times the burst, offline clients, stricter consistency, a failed region, or half the budget. Ask the candidate to revise the design, not merely name another service.
...
[Interview home](interview-guide.md) · [Evidence behind this path](../docs/research/interview-evidence.md)
